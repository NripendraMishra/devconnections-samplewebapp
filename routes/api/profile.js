...
const validExperienceInput = require('../../validator/experience')
    ...
    Profile.findOne({
        ...
        .then(profile => {
           // Get remove index
            ...
            // Save
            profile.save().then(profile => res.status(200).json(profile)).then(err => console.log(err))
        })
        .catch(err => console.log(err))
...
router.post('/education', passport.authenticate('jwt', {
    ...
    Profile.findOne({
        ...
        .then(profile => {
            ...
            profile.save().then(profile => res.status(200).json(profile)).catch(err => console.log(err))
        })
        .catch(err => console.log(err))
